		...
		class RibbonPool : Pool<Ribbon>
		{
			...
			private void CreateRibbons()
			{
				...
				foreach (CelestialBody body in PSystemManager.Instance.localBodies)
				{
					...
					Log.Detail("creating ribbons for " + bodyName + ", base prestige is " + basePrestige + "type is " +
							   body.RevealType());
					...
					for (int i = 1; i <= 2; i++)
					{
						...
						AddRibbon(
							orbitRibbon = new Ribbon(BODY_RIBBON_PATH + prefix + "OrbitCapsule", orbit, first ? orbitRibbon : soiRibbon));
						AddRibbon(evaRibbon = new Ribbon(BODY_RIBBON_PATH + prefix + "EvaSpace", eva, first ? evaRibbon : soiRibbon));
						AddRibbon(
							evaOrbitRibbon =
								new Ribbon(BODY_RIBBON_PATH + prefix + "EvaOrbit", evaorbit, first ? evaOrbitRibbon : orbitRibbon));
						AddRibbon(
							orbitDockedRibbon =
								new Ribbon(BODY_RIBBON_PATH + prefix + "OrbitCapsuleDocked", docked, first ? orbitDockedRibbon : orbitRibbon));
						...
						if (!body.IsSun())
						{
							...
							if (!mapper.IsGasGiant(body))
							{
								...
								AddRibbon(
									landingRibbon = new Ribbon(BODY_RIBBON_PATH + prefix + "Landing", landing, first ? landingRibbon : soiRibbon));
								AddRibbon(
									evagroundRibbon =
										new Ribbon(BODY_RIBBON_PATH + prefix + "EvaGround", evaground, first ? evagroundRibbon : landingRibbon));
								AddRibbon(
									flagRibbon = new Ribbon(BODY_RIBBON_PATH + prefix + "PlantFlag", flag, first ? flagRibbon : evagroundRibbon));
								AddRibbon(
									roverRibbon = new Ribbon(BODY_RIBBON_PATH + prefix + "Rover", rover, first ? roverRibbon : evagroundRibbon));
							}
						}
						...
						if (body.atmosphere)
						{
							...
							if (!body.isHomeWorld)
							{
								AddRibbon(
									atmosphereRibbon =
										new Ribbon(BODY_RIBBON_PATH + prefix + "Atmosphere", atmosphere, first ? atmosphereRibbon : soiRibbon));
							}
						}
						...
						if (mapper.IsGasGiant(body))
						{
							...
							{
								//  deep athmosphere
								AddRibbon(new Ribbon(BODY_RIBBON_PATH + prefix + "DeepAtmosphere",
									new DeepAtmosphereArchievement(body, basePrestige + 90), soiRibbon));
							}
						}
						...
						if (body.IsSun())
						{
							...
							if (innermost != null)
							{
								...
								closerSolarOrbitRibbon = new Ribbon(BODY_RIBBON_PATH + prefix + "CloserSolarOrbit",
									new CloserSolarOrbitAchievement(body, 50500 + i, innermost, first), first ? closerSolarOrbitRibbon : soiRibbon);
				...
				Ribbon ribbonTwentyOrMoreMissions = new Ribbon(_RP + "Missions20", flownTwentyOrMoreMissions,
					ribbonFiveOrMoreMissions);
				Ribbon ribbonFiftyOrMoreMissions = new Ribbon(_RP + "Missions50", flownFiftyOrMoreMissions,
					ribbonTwentyOrMoreMissions);
				...
				Ribbon ribbonFastOrbit4 = new Ribbon(_RP + "FastOrbit5", fastOrbit4, ribbonFastOrbit3);
				// FastOrbit4 skipped, because of upper/lower case problems in file name
				...
				Ribbon ribbonMissionTime2000days = new Ribbon(_RP + "LongMissionTime6", missionTime2000days,
					ribbonMissionTime500days);
				Ribbon ribbonMissionTime5000days = new Ribbon(_RP + "LongMissionTime7", missionTime5000days,
					ribbonMissionTime2000days);
				...
				AddRibbon(
					solidFuelLaunch20 =
						new Ribbon(_RP + "SolidFuelBooster20", new SolidFuelLaunchAchievement(20, 720), solidFuelLaunch10));
				...
				Ribbon heavyVehicleLanding2 = new Ribbon(_RP + "HeavyVehicleLanding2", new HeavyVehicleLandAchievement(500, 422),
					heavyVehicleLanding1);
				Ribbon heavyVehicleLanding3 = new Ribbon(_RP + "HeavyVehicleLanding3", new HeavyVehicleLandAchievement(750, 423),
					heavyVehicleLanding2);
				Ribbon heavyVehicleLanding4 = new Ribbon(_RP + "HeavyVehicleLanding4", new HeavyVehicleLandAchievement(1000, 424),
					heavyVehicleLanding3);
				Ribbon heavyVehicleLanding5 = new Ribbon(_RP + "HeavyVehicleLanding5", new HeavyVehicleLandAchievement(1500, 425),
					heavyVehicleLanding4);
				Ribbon heavyVehicleLanding6 = new Ribbon(_RP + "HeavyVehicleLanding6", new HeavyVehicleLandAchievement(2000, 426),
					heavyVehicleLanding5);
				Ribbon heavyVehicleLanding7 = new Ribbon(_RP + "HeavyVehicleLanding7", new HeavyVehicleLandAchievement(4000, 427),
					heavyVehicleLanding6);
				...
				Ribbon heavyVehicleLaunch2 = new Ribbon(_RP + "HeavyVehicleLaunch2", new HeavyVehicleLaunchAchievement(500, 412),
					heavyVehicleLaunch1);
				Ribbon heavyVehicleLaunch3 = new Ribbon(_RP + "HeavyVehicleLaunch3", new HeavyVehicleLaunchAchievement(750, 413),
					heavyVehicleLaunch2);
				Ribbon heavyVehicleLaunch4 = new Ribbon(_RP + "HeavyVehicleLaunch4", new HeavyVehicleLaunchAchievement(1000, 414),
					heavyVehicleLaunch3);
				Ribbon heavyVehicleLaunch5 = new Ribbon(_RP + "HeavyVehicleLaunch5", new HeavyVehicleLaunchAchievement(1500, 415),
					heavyVehicleLaunch4);
				Ribbon heavyVehicleLaunch6 = new Ribbon(_RP + "HeavyVehicleLaunch6", new HeavyVehicleLaunchAchievement(2000, 416),
					heavyVehicleLaunch5);
				Ribbon heavyVehicleLaunch7 = new Ribbon(_RP + "HeavyVehicleLaunch7", new HeavyVehicleLaunchAchievement(4000, 417),
					heavyVehicleLaunch6);
				...
				Ribbon northPolar1st = new Ribbon(_RP + "FirstNorthPolar", new PolarLandingAchievement("North", 492, true),
					northPolar);
				Ribbon southPolar = new Ribbon(_RP + "SouthPolar", new PolarLandingAchievement("South", 493, false));
				Ribbon southPolar1st = new Ribbon(_RP + "FirstSouthPolar", new PolarLandingAchievement("South", 494, true),
					southPolar);
				...
				Ribbon evaTime2 = new Ribbon(_RP + "TotalEva2", new EvaTotalTimeAchievement(Utils.ConvertHoursToSeconds(2), 472),
					evaTime1);
				Ribbon evaTime3 = new Ribbon(_RP + "TotalEva3", new EvaTotalTimeAchievement(Utils.ConvertHoursToSeconds(6), 473),
					evaTime2);
				Ribbon evaTime4 = new Ribbon(_RP + "TotalEva4", new EvaTotalTimeAchievement(Utils.ConvertHoursToSeconds(12), 474),
					evaTime3);
				Ribbon evaTime5 = new Ribbon(_RP + "TotalEva5", new EvaTotalTimeAchievement(Utils.ConvertHoursToSeconds(24), 475),
					evaTime4);
				Ribbon evaTime6 = new Ribbon(_RP + "TotalEva6", new EvaTotalTimeAchievement(Utils.ConvertHoursToSeconds(48), 476),
					evaTime5);
				Ribbon evaTime7 = new Ribbon(_RP + "TotalEva7", new EvaTotalTimeAchievement(Utils.ConvertHoursToSeconds(96), 477),
					evaTime6);
				Ribbon evaTime8 = new Ribbon(_RP + "TotalEva8", new EvaTotalTimeAchievement(Utils.ConvertHoursToSeconds(192), 478),
					evaTime7);
				AddRibbon(evaTime1);
				AddRibbon(evaTime2);
				AddRibbon(evaTime3);
				...
				Ribbon evaEndurance2 = new Ribbon(_RP + "Eva2", new EvaTimeAchievement(3 * Utils.ConvertHoursToSeconds(1) / 6, 452),
					evaEndurance1);
				Ribbon evaEndurance3 = new Ribbon(_RP + "Eva3", new EvaTimeAchievement(4 * Utils.ConvertHoursToSeconds(1) / 6, 453),
					evaEndurance2);
				Ribbon evaEndurance4 = new Ribbon(_RP + "Eva4", new EvaTimeAchievement(5 * Utils.ConvertHoursToSeconds(1) / 6, 454),
					evaEndurance3);
				Ribbon evaEndurance5 = new Ribbon(_RP + "Eva5", new EvaTimeAchievement(1 * Utils.ConvertHoursToSeconds(1), 455),
					evaEndurance4);
				Ribbon evaEndurance6 = new Ribbon(_RP + "Eva6", new EvaTimeAchievement(3 * Utils.ConvertHoursToSeconds(1) / 2, 456),
					evaEndurance5);
				Ribbon evaEndurance7 = new Ribbon(_RP + "Eva7", new EvaTimeAchievement(1 * Utils.ConvertHoursToSeconds(2), 457),
					evaEndurance6);
				Ribbon evaEndurance8 = new Ribbon(_RP + "Eva8", new EvaTimeAchievement(1 * Utils.ConvertHoursToSeconds(3), 458),
					evaEndurance7);
				Ribbon evaEndurance9 = new Ribbon(_RP + "Eva9", new EvaTimeAchievement(1 * Utils.ConvertHoursToSeconds(4), 459),
					evaEndurance8);
				Ribbon evaEndurance10 = new Ribbon(_RP + "Eva10", new EvaTimeAchievement(1 * Utils.ConvertHoursToSeconds(5), 460),
					evaEndurance9);
				...
				//
				// Contract Prestige
				Ribbon significantContract = new Ribbon(_RP + "SignificantContract",
					new ContractPrestigeAchievement(Contracts.Contract.ContractPrestige.Significant, 68));
				Ribbon exceptionalContract = new Ribbon(_RP + "ExceptionalContract",
					new ContractPrestigeAchievement(Contracts.Contract.ContractPrestige.Exceptional, 69), significantContract);
				...
				AddRibbon(new Ribbon(_RP + "XM",
					new DateofYearAchievement(24, 12, 26, 12, "X-mas", "Awarded for any kind of duty on xmas", 1)));
				AddRibbon(new Ribbon(_RP + "July4",
					new DateofYearAchievement(4, 7, 4, 7, "4th July", "Awarded for any kind of duty on 4th of July", 3)));
				AddRibbon(new Ribbon(_RP + "Anniversary",
					new DateofYearAchievement(27, 4, 27, 4, "Anniversary",
						"Awarded for any kind of duty on any anniversary of the kerbal space program", 4)));
				//
				...
				if (jool != null)
				{
					this.JoolTourRibbon = new Ribbon(_RP + "JoolTour",
						new JoolTourAchievement(mapper.GetBasePrestige(jool) + 98, false));
			...
			private void CreateCustomRibbons()
			{
				...
				CreateCustomRibbon(0, "Diamond", "Diamond",
					"The highest honor awarded for exceptional courage, unselfishness and valor");
				CreateCustomRibbon(1, "InterSidera", "Inter Sidera",
					"\"Among the Stars\" - A commemorative ribbon for fallen kerbonauts");
				...
				CreateCustomRibbon(6, "CertifiedBadass", "Certified Badass",
					"Awarded for ludicrous, near-impossible and brave endeavor");
				...
				CreateCustomRibbon(22, "STM02", "Expeditionary Command",
					"Awarded for being in command of a significant expedition, station or base");
				CreateCustomRibbon(23, "STM03", "Mission Command", "Awarded for being in command of a small scale mission");
				CreateCustomRibbon(24, "STM04", "Chief Scientist",
					"Awarded for being a Lead Scientist on a significant expedition, or a mission with a major scientific task",
					this.ServiceScientist);
				CreateCustomRibbon(25, "STM05", "Chief Engineering",
					"Awarded for being the Lead Engineer on a significant expedition or mission with a major engineering task",
					this.ServiceEngineer);
				CreateCustomRibbon(26, "STM06", "Space Search & Rescue",
					"Awarded for being involved in a search and rescue mission in space");
				...
				CreateCustomRibbon(29, "STM09", "Chief Operations",
					"Awarded for being the lead officer in charge of operations on a significant expedition or mission with a major piloting task or series of tasks",
					this.ServiceOperations);
				CreateCustomRibbon(30, "STM10", "Arrow", "");
				CreateCustomRibbon(31, "STM11", "Qualified Scientist",
					"Awarded for having the necessary skills and knowledge, and completing the space mission training program");
				CreateCustomRibbon(32, "STM12", "Qualified Operations",
					"Awarded for having the necessary skills and knowledge, and completing the space mission training program");
				CreateCustomRibbon(33, "STM13", "Qualified Engineering",
					"Awarded for having the necessary skills and knowledge, and completing the space mission training program");
				CreateCustomRibbon(34, "STM14", "Specialist Scientist",
					"Awarded for developing and demonstrating specialist aptitude in field activities for the Kerbal Space Program", 31);
				CreateCustomRibbon(35, "STM15", "Specialist Operations",
					"Awarded for developing and demonstrating specialist aptitude in field activities for the Kerbal Space Program", 32);
				CreateCustomRibbon(36, "STM16", "Specialist Engineering",
					"Awarded for developing and demonstrating specialist aptitude in field activities for the Kerbal Space Program", 33);
				CreateCustomRibbon(37, "STM17", "Senior Scientist",
					...
					34);
				CreateCustomRibbon(38, "STM18", "Senior Operations",
					"Awarded for leadership, significant experience and outstanding technical aptitude in field activities for the Kerbal Space Program",
					35);
				CreateCustomRibbon(39, "STM19", "Senior Engineering",
					"Awarded for leadership, significant experience and outstanding technical aptitude in field activities for the Kerbal Space Program",
					36);
				CreateCustomRibbon(40, "STM20", "STM20", "no description");
				CreateCustomRibbon(41, "STM21", "STM21", "no description");
				CreateCustomRibbon(42, "STM22", "Repair In Danger",
					"Awarded for courage demonstrated in engaging in repair activities in dangerous circumstances");
				CreateCustomRibbon(43, "STM23", "Rover Specialist",
					"Awarded for having developed skills and expertise as a driver of a land vehicle");
				CreateCustomRibbon(44, "STM24", "EVA Specialist",
					"Awarded for having developed skills and expertise in conducting and overseeing EVA activities");
			...
			public Ribbon RegisterExternalRibbon(string code, string pathToRibbonTexture, string name, string description,
				bool first = false, int prestige = 0)
			{
			...
			public Ribbon RegisterCustomRibbon(int id, string pathToRibbonTexture, string name, string description,
				int prestige = 0)
			{
