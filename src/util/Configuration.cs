...
namespace Nereid
{
	namespace FinalFrontier
	{
		public class Configuration
		{
			...
			private Dictionary<GameScenes, HallOfFameBrowser.HallOfFameFilter> hallOfFameFilter =
				new Dictionary<GameScenes, HallOfFameBrowser.HallOfFameFilter>();

			private Dictionary<GameScenes, HallOfFameBrowser.HallOfFameSorter> hallOfFameSorter =
				new Dictionary<GameScenes, HallOfFameBrowser.HallOfFameSorter>();
          ...
          */
			...
			{
				short cnt = (short)hallOfFameFilter.Count;
			...
			{
				short cnt = (short)hallOfFameSorter.Count;
			...
			private void ReadHallOfFameFilter(BinaryReader reader)
			{
				...
				short cnt = (short)reader.ReadInt16();
				for (int i = 0; i < cnt; i++)
				{
			...
			public void Save()
			{
				...
				try
				{
					using (BinaryWriter writer = new BinaryWriter(File.Open(filename, FileMode.Create)))
					{
						...
						// File Version
						writer.Write((short)FILE_MARKER); // marker
