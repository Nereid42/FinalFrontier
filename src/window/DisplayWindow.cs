	...
	namespace FinalFrontier
	{
		class DisplayWindow : PositionableWindow
		{
			...
			protected override void OnWindow(int id)
			{
				...
				GUILayout.EndHorizontal();
				scrollPosRibbons = GUILayout.BeginScrollView(scrollPosRibbons, FFStyles.STYLE_SCROLLVIEW,
					GUILayout.Width(RIBBON_DISPLAY_WIDTH), GUILayout.Height(RIBBON_DISPLAY_HEIGHT));
				switch (mode)
				{
					case MODE.DISPLAY:
						DrawRibbons();
				...
				scrollPosLogbook = GUILayout.BeginScrollView(scrollPosLogbook, FFStyles.STYLE_SCROLLVIEW,
					GUILayout.Width(RIBBON_DISPLAY_WIDTH), GUILayout.Height(RIBBON_LOGBOOK_HEIGHT));
